...
for(i in 1:length(PAX_v6_PEV$abbreviation)){
  if(PAX_v6_PEV$abbreviation[i] == "STSM"){
    ...
    PAX_v6_PEV$additionalRemarks[i] <- "Both the name of the region and its abbreviation have spelling mistakes (name: 'Lateral part' is lacking the space between the words; abbreviation: should read 'STSL' istead of 'STSM'). The assumed correct name 'bed nucleus of stria terminalis, supracapsular division, lateral part' has been added under 'correctedName'. The assumed correct abbreviation 'STSL' has been added under 'abbreviation'. 'STSM' has been added under 'alternateName'."
...
PAX_v6_CCSV_BrLe_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                             ...
                             accessibility = ifelse(PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "accessibility"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "accessibility"]))),
                             anatomicalAxesOrientation = ifelse(PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "anatomicalAxesOrientation"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "anatomicalAxesOrientation"]))),
                             ...
                             digitalIdentifier = ifelse(PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "digitalIdentifier"]))),
                             fullDocumentation = list(list(at_id = PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "fullDocumentation"])),
                             ...
                             isNewVersionOf = ifelse(PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "isNewVersionOf"]))), 
                             ...
                             license = ifelse(PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "license"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "license"]))), 
                             nativeUnit = ifelse(PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "nativeUnit"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "nativeUnit"]))), 
                             ...
                             repository = ifelse(PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "repository"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrLe$VALUE[PAX_v6_cor_CCSV_BrLe$KEY == "repository"]))),
...
PAX_v6_CCSV_BrRi_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                              ...
                              accessibility = ifelse(PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "accessibility"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "accessibility"]))),
                              anatomicalAxesOrientation = ifelse(PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "anatomicalAxesOrientation"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "anatomicalAxesOrientation"]))),
                              ...
                              digitalIdentifier = ifelse(PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "digitalIdentifier"]))),
                              fullDocumentation = list(list(at_id = PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "fullDocumentation"])),
                              ...
                              isNewVersionOf = ifelse(PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "isNewVersionOf"]))), 
                              ...
                              license = ifelse(PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "license"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "license"]))), 
                              nativeUnit = ifelse(PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "nativeUnit"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "nativeUnit"]))), 
                              ...
                              repository = ifelse(PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "repository"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_BrRi$VALUE[PAX_v6_cor_CCSV_BrRi$KEY == "repository"]))),
...
PAX_v6_CCSV_IALe_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                              ...
                              accessibility = ifelse(PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "accessibility"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "accessibility"]))),
                              anatomicalAxesOrientation = ifelse(PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "anatomicalAxesOrientation"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "anatomicalAxesOrientation"]))),
                              ...
                              digitalIdentifier = ifelse(PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "digitalIdentifier"]))),
                              fullDocumentation = list(list(at_id = PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "fullDocumentation"])),
                              ...
                              isNewVersionOf = ifelse(PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "isNewVersionOf"]))), 
                              ...
                              license = ifelse(PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "license"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "license"]))), 
                              nativeUnit = ifelse(PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "nativeUnit"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "nativeUnit"]))), 
                              ...
                              repository = ifelse(PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "repository"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IALe$VALUE[PAX_v6_cor_CCSV_IALe$KEY == "repository"]))),
...
PAX_v6_CCSV_IARi_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                              ...
                              accessibility = ifelse(PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "accessibility"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "accessibility"]))),
                              anatomicalAxesOrientation = ifelse(PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "anatomicalAxesOrientation"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "anatomicalAxesOrientation"]))),
                              ...
                              digitalIdentifier = ifelse(PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "digitalIdentifier"]))),
                              fullDocumentation = list(list(at_id = PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "fullDocumentation"])),
                              ...
                              isNewVersionOf = ifelse(PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "isNewVersionOf"]))), 
                              ...
                              license = ifelse(PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "license"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "license"]))), 
                              nativeUnit = ifelse(PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "nativeUnit"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "nativeUnit"]))), 
                              ...
                              repository = ifelse(PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "repository"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCSV_IARi$VALUE[PAX_v6_cor_CCSV_IARi$KEY == "repository"]))),
...
PAX_CCSVs <- c(list(list(at_type = PAX_v6_CCSV_BrLe_list$at_id)),
               list(list(at_type = PAX_v6_CCSV_BrRi_list$at_id)),
               list(list(at_type = PAX_v6_CCSV_IALe_list$at_id)),
               list(list(at_type = PAX_v6_CCSV_IARi_list$at_id)))
...
PAX_v6_cor_CCS_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                            ...
                            digitalIdentifier = ifelse(PAX_v6_cor_CCS$VALUE[PAX_v6_cor_CCS$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCS$VALUE[PAX_v6_cor_CCS$KEY == "digitalIdentifier"]))),
                            ...
                            usedSpecies = ifelse(PAX_v6_cor_CCS$VALUE[PAX_v6_cor_CCS$KEY == "usedSpecies"] == "NA", NA, list(list(at_id = PAX_v6_cor_CCS$VALUE[PAX_v6_cor_CCS$KEY == "usedSpecies"]))))
...
PAX_v6_cor_BAV_BrLe_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                            ...
                            accessibility = ifelse(PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "accessibility"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "accessibility"]))),
                            ...
                            coordinateSpace = list(list(at_id = PAX_v6_CCSV_BrLe_list$at_id)),
                            copyright = NA,
                            ...
                            digitalIdentifier = list(list(at_id = paste("https://openminds.ebrains.eu/instances/ISBN/", PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "digitalIdentifier"], sep = ""))),
                            fullDocumentation = list(list(at_id = PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "fullDocumentation"])),
                            ...
                            isNewVersionOf = ifelse(PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "isNewVersionOf"]))), 
                            ...
                            license = ifelse(PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "license"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "license"]))), 
                            ...
                            repository = ifelse(PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "repository"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "repository"]))),
                            ...
                            type = ifelse(PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "type"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrLe$VALUE[PAX_v6_cor_BAV_BrLe$KEY == "type"]))),
...
PAX_v6_cor_BAV_BrRi_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                                 ...
                                 accessibility = ifelse(PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "accessibility"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "accessibility"]))),
                                 ...
                                 coordinateSpace = list(list(at_id = PAX_v6_CCSV_BrRi_list$at_id)),
                                 copyright = NA,
                                 ...
                                 digitalIdentifier = list(list(at_id = paste("https://openminds.ebrains.eu/instances/ISBN/", PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "digitalIdentifier"], sep = ""))),
                                 fullDocumentation = list(list(at_id = PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "fullDocumentation"])),
                                 ...
                                 isNewVersionOf = ifelse(PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "isNewVersionOf"]))), 
                                 ...
                                 license = ifelse(PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "license"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "license"]))), 
                                 ...
                                 repository = ifelse(PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "repository"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "repository"]))),
                                 ...
                                 type = ifelse(PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "type"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_BrRi$VALUE[PAX_v6_cor_BAV_BrRi$KEY == "type"]))),
...
PAX_v6_cor_BAV_IALe_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                                 ...
                                 accessibility = ifelse(PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "accessibility"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "accessibility"]))),
                                 ...
                                 coordinateSpace = list(list(at_id = PAX_v6_CCSV_IALe_list$at_id)),
                                 copyright = NA,
                                 ...
                                 digitalIdentifier = list(list(at_id = paste("https://openminds.ebrains.eu/instances/ISBN/", PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "digitalIdentifier"], sep = ""))),
                                 fullDocumentation = list(list(at_id = PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "fullDocumentation"])),
                                 ...
                                 isNewVersionOf = ifelse(PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "isNewVersionOf"]))), 
                                 ...
                                 license = ifelse(PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "license"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "license"]))), 
                                 ...
                                 repository = ifelse(PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "repository"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "repository"]))),
                                 ...
                                 type = ifelse(PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "type"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IALe$VALUE[PAX_v6_cor_BAV_IALe$KEY == "type"]))),
...
PAX_v6_cor_BAV_IARi_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                                 ...
                                 accessibility = ifelse(PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "accessibility"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "accessibility"]))),
                                 ...
                                 coordinateSpace = list(list(at_id = PAX_v6_CCSV_IARi_list$at_id)),
                                 copyright = NA,
                                 ...
                                 digitalIdentifier = list(list(at_id = paste("https://openminds.ebrains.eu/instances/ISBN/", PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "digitalIdentifier"], sep = ""))),
                                 fullDocumentation = list(list(at_id = PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "fullDocumentation"])),
                                 ...
                                 isNewVersionOf = ifelse(PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "isNewVersionOf"]))), 
                                 ...
                                 license = ifelse(PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "license"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "license"]))), 
                                 ...
                                 repository = ifelse(PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "repository"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "repository"]))),
                                 ...
                                 type = ifelse(PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "type"] == "NA", NA, list(list(at_id = PAX_v6_cor_BAV_IARi$VALUE[PAX_v6_cor_BAV_IARi$KEY == "type"]))),
...
PAX_v6_cor_BA_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                           ...
                           digitalIdentifier = ifelse(PAX_v6_cor_BA$VALUE[PAX_v6_cor_BA$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = PAX_v6_cor_BA$VALUE[PAX_v6_cor_BA$KEY == "digitalIdentifier"]))),
                           ...
                           usedSpecies = ifelse(PAX_v6_cor_BA$VALUE[PAX_v6_cor_BA$KEY == "usedSpecies"] == "NA", NA, list(list(at_id = PAX_v6_cor_BA$VALUE[PAX_v6_cor_BA$KEY == "usedSpecies"]))))

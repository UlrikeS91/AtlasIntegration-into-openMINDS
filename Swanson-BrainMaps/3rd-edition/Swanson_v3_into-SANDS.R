...
Swanson_AxesOr <- c(list(list(at_type = "https://openminds.ebrains.eu/core/QuantitativeValue",
                              ...
                              uncertainty = NA,
                              unit =  ifelse(Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "nativeUnit"] == "NA", NA, list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "nativeUnit"]))),
                              value = 0)),
...
Swanson_v3_CCSV_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                             ...
                             accessibility = ifelse(Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "accessibility"] == "NA", NA, list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "accessibility"]))),
                             anatomicalAxesOrientation = ifelse(Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "anatomicalAxesOrientation"] == "NA", NA, list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "anatomicalAxesOrientation"]))),
                             ...
                             digitalIdentifier = ifelse(Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "digitalIdentifier"]))),
                             fullDocumentation = list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "fullDocumentation"])),
                             ...
                             isNewVersionOf = ifelse(Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "isNewVersionOf"]))), 
                             ...
                             license = ifelse(Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "license"] == "NA", NA, list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "license"]))), 
                             nativeUnit = ifelse(Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "nativeUnit"] == "NA", NA, list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "nativeUnit"]))), 
                             ...
                             repository = ifelse(Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "repository"] == "NA", NA, list(list(at_id = Swanson_v3_CCSV$VALUE[Swanson_v3_CCSV$KEY == "repository"]))),
...
Swanson_v3_CCS_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                            ...
                            digitalIdentifier = ifelse(Swanson_v3_CCS$VALUE[Swanson_v3_CCS$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = Swanson_v3_CCS$VALUE[Swanson_v3_CCS$KEY == "digitalIdentifier"]))),
                            ...
                            usedSpecies = ifelse(Swanson_v3_CCS$VALUE[Swanson_v3_CCS$KEY == "usedSpecies"] == "NA", NA, list(list(at_id = Swanson_v3_CCS$VALUE[Swanson_v3_CCS$KEY == "usedSpecies"]))))
...
Swanson_v3_BAV_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                             ...
                             accessibility = ifelse(Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "accessibility"] == "NA", NA, list(list(at_id = Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "accessibility"]))),
                             ...
                             coordinateSpace = list(list(at_id = Swanson_v3_CCSV_list$at_id)),
                             copyright = NA,
                             ...
                             digitalIdentifier = list(list(at_id = paste("https://openminds.ebrains.eu/instances/ISBN/", Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "digitalIdentifier"], sep = ""))),
                             fullDocumentation = list(list(at_id = Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "fullDocumentation"])),
                             ...
                             isNewVersionOf = ifelse(Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "isNewVersionOf"] == "NA", NA, list(list(at_id = Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "isNewVersionOf"]))), 
                             ...
                             license = ifelse(Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "license"] == "NA", NA, list(list(at_id = Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "license"]))), 
                             ...
                             repository = ifelse(Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "repository"] == "NA", NA, list(list(at_id = Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "repository"]))),
                             ...
                             type = ifelse(Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "type"] == "NA", NA, list(list(at_id = Swanson_v3_BAV$VALUE[Swanson_v3_BAV$KEY == "type"]))),
...
Swanson_v3_BA_list <- list(at_context = list(at_vocab = "https://openminds.ebrains.eu/vocab/"),
                            ...
                            digitalIdentifier = ifelse(Swanson_v3_BA$VALUE[Swanson_v3_BA$KEY == "digitalIdentifier"] == "NA", NA, list(list(at_id = Swanson_v3_BA$VALUE[Swanson_v3_BA$KEY == "digitalIdentifier"]))),
                            ...
                            usedSpecies = ifelse(Swanson_v3_BA$VALUE[Swanson_v3_BA$KEY == "usedSpecies"] == "NA", NA, list(list(at_id = Swanson_v3_BA$VALUE[Swanson_v3_BA$KEY == "usedSpecies"]))))
